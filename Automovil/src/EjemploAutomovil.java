...
public class EjemploAutomovil {
    public static void main(String[] args) {
        ...
        Automovil nissan2 = new Automovil("Nissan", "Navara", Color.GRIS, new Motor(3.5, TipoMotor.GASOLINA), new Estanque(50));
        ...
        System.out.println("Kilmetros por litro: " + nissan.calcularConsumo(300, 60));
